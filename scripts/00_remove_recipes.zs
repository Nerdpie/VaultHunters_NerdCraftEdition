...
mods.jei.JEI.hideItem(<item:the_vault:final_vault_portal>);
...
//mods.jei.JEI.hideItem(<item:industrialforegoing:mob_imprisonment_tool>);
//mods.jei.JEI.hideItem(<item:industrialforegoing:meat_feeder>);
